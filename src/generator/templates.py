...
<div class="footer">
  <p><span class="lang-zh">由 DocPortal 生成</span><span class="lang-en">Generated by DocPortal</span> | {escaped_folder}</p>
</div>

<div class="copilot-hint">
  ═══════════════════════════════
  DocPortal 知识页 / Knowledge Page | {escaped_title}
...
<div class="skip-notice">
  ...
  <p>
    <span class="lang-zh">此文件格式不在 DocPortal 支持的解析范围之内，已自动跳过。</span>
    <span class="lang-en">This file format is not supported by DocPortal and has been skipped.</span><br>
...
<div class="footer">
  <p>
    <span class="lang-zh">由 DocPortal 生成</span><span class="lang-en">Generated by DocPortal</span>
